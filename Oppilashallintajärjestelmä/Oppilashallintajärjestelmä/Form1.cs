...
namespace Oppilashallintajärjestelmä
{
    public partial class Form1 : Form
    {
        ...
        private void PoistaBT_Click(object sender, EventArgs e)
        {
            ...
            {
                TietotauluDG.DataSource = opiskelija.haeOpiskelijat();
                MessageBox.Show("Opiskelija poistettu onnistuneesti", "Opiskelian poisto", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
            else
            {
                MessageBox.Show("Opiskelija ei pystytty poistamaan", "Opiskelijan poisto", MessageBoxButtons.OK, MessageBoxIcon.Information);
            }
